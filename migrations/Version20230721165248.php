 ...
 */
final class Version20230721165248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review ADD CONSTRAINT FK_794381C68BAC62AF FOREIGN KEY (city_id) REFERENCES city (id) ON DELETE CASCADE');
